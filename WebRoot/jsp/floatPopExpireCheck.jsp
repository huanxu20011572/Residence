						...
						if(personType=='1'){
							...
							$.ajax({
											...
											success:function(minfo){
												...
												$('#oWnername').val(data[0].name);
												$('#oWneroldName').val(data[0].oldName);
												$('#oWnersex').val(data[0].maritalSta);
							...
							$('#dg').datagrid({   
							   ...
							   columns:[[
									...
									{field:'maritalSta',title:'婚姻状况',width:150},
									{field:'militarySta',title:'兵役状况',width:150},
									...
									{field:'imgPersonUrl',title:'个人照片',hidden:true},
									{field:'rentDate ',title:'租住时间',width:150},
									{field:'rentReason',title:'暂住事由',width:150},
									{field:'liveDate',title:'居住时间',width:150},
									{field:'rentalTime',title:'到租时间',width:150}
								//	{field:'version',title:'版本号',width:150},
								]]   
							});
							$('#dlg3').dialog('open');
