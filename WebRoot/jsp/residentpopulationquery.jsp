	...
	function getListPage(){
				$('#list').datagrid({			
					...
					columns:[[
						...
						{field:'tempLiveDate',title:'暂住时间',width:60},
						{field:'rentDate',title:'租住时间',width:60},
						...
						{field:'rentalTime',title:'到租时间',width:90},
...
<body>
	<div class="easyui-layout" data-options="fit:true">
			...
			<div id="show"  data-options="region:'center'" style="height:500px;">
				<div id="list"></div>
			</div>
	</div>
				...
				<table data-options="region:',border:false,fit:true,fitColumns:false" cellspacing="5" >
						...
						<tr>
						   ...
						   <td align="right">居住时间：</td>
							...
							<td align="right">租住日期：</td>
							<td ><input class="easyui-validatebox"  id="rentDatem" name="rentDatem" ></input></td>
						 </tr>
						 <tr>
